...
proc swapp_get_description {} {
    return "SCU-Firmware: Generate Firmware for TE-System Controller IP MCS";
}
...
proc check_stdout_sw {} {
    ...
    if { $stdout == "none" } {
        error "The STDOUT parameter is not set on the OS. SCU-Firmware requires stdout to be set."
    }
}
