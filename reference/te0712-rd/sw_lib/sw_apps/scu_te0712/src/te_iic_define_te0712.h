...
//Decrease DELAY to speed up the PLL programming via I2C. On your on risk, it might not work if bits change too fast. Originally it was 1000, set by Oleksandr Kiyenko
//DELAY is used in te_iic_platform.c
#define DELAY	100
