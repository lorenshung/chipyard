proc swapp_get_name {} {
    return "Hello Trenz Module TE0712";
}

proc swapp_get_description {} {
    return "Let's say 'Hello Trenz Module(TE0712)'  with endless loop in C.";
}
...
proc swapp_get_supported_processors {} {
    return "microblaze ps7_cortexa9 psu_cortexa53 psu_cortexr5";
}
