...
@echo -- Error: Need  LabTools to run. --
...
call vivado_lab -source ../scripts/script_main.tcl  -mode batch -notrace -tclargs --run_labtools --boardpart %PARTNUMBER%
