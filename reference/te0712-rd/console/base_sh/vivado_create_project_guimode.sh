...
# --   remove sdsoc
# --$Version: 1.6 Changes
# --    open gui after project generation(bugfix vivado 21.2)
# -- 1.5 Changes
# --    update 2019.2
# --$Version: 1.4 $
...
function vivado_start {
  ...
  vivado -source ../scripts/script_main.tcl  -mode batch -notrace -tclargs --run 1 --gui 2 --clean 2 --boardpart ${PARTNUMBER}
