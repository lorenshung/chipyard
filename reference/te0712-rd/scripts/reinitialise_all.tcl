...
# --                |               |         |         |
# ------------------|---------------|---------|---------|----------------------------------------------------------------------
# -- 2024-12-09     |               |JH       |         |- remove script_sdsoc.tcl file
# ------------------|---------------|---------|---------|----------------------------------------------------------------------
# -- 2023-05-25     |               |JH       |         |- bugfix path for script_jtag.tcl
# ------------------|---------------|---------|---------|----------------------------------------------------------------------
# -- 2023-05-09     |               |JH       |         |- new change history
# --                |               |         |         |- add script_jtag.tcl
# ------------------|---------------|---------|---------|----------------------------------------------------------------------
# -- 2021/07/26     |               |JH       |         |- add petalinux tcl
# ------------------|---------------|---------|---------|----------------------------------------------------------------------
# -- 2018/01/17     |               |JH       |         |- bugfix to start on uninitialized project
# ------------------|---------------|---------|---------|----------------------------------------------------------------------
# -- 2017/09/04     |               |JH       |         |- add new document history style
# ------------------|---------------|---------|---------|----------------------------------------------------------------------
# -- 2017/02/02     |               |JH       |         |- miscellaneous
# ------------------|---------------|---------|---------|----------------------------------------------------------------------
# -- 2016/02/08     |               |JH       |         |- initial release
# ------------------|---------------|---------|---------|----------------------------------------------------------------------
...
namespace eval TE {
  puts "------------"
  if {![info exists TE::VIVADO_AVAILABLE] } {set VIVADO_AVAILABLE 1; puts "TE INFO: VIVADO_AVAILABLE doesn't exist,set TE::VIVADO_AVAILABLE true"}
  if {![info exists TE::LABTOOL_AVAILABLE] } {set LABTOOL_AVAILABLE 0; puts "TE INFO: LABTOOL_AVAILABLE doesn't exist,set TE::LABTOOL_AVAILABLE false"}
  if {![info exists TE::SDK_AVAILABLE] } {set SDK_AVAILABLE 1; puts "TE INFO: SDK_AVAILABLE doesn't exist,set TE::SDK_AVAILABLE true"}
  if {![info exists TE::SDSOC_AVAILABLE] } {set SDSOC_AVAILABLE 0; puts "TE INFO: SDSOC_AVAILABLE doesn't exist,set TE::SDSOC_AVAILABLE false"}
  puts "------------\n"
}

proc reinitialise {} {

  catch {TE::UTILS::te_msg TE_INIT-59 INFO "Reinitialise Scripts \n \
  ...
  source ./scripts/script_jtag.tcl
