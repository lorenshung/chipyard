...
# --                |               |         |         |
# ------------------|---------------|---------|---------|----------------------------------------------------------------------
# -- 2025-01-27     |2024.2.1       |JH       |         |- modified script_petalinux, scripts_enviroment, scripts_te_utils
# ------------------|---------------|---------|---------|----------------------------------------------------------------------
# -- 2024-11-29     |2024.2.0       |JH       |         |- 2024.2 initial release
# ------------------|---------------|---------|---------|----------------------------------------------------------------------
# -- 2024-01-08     |2023.2.4       |JH       |         |- init_app_lists, bugfix DATA01_FILE for MB
# ------------------|---------------|---------|---------|----------------------------------------------------------------------
# -- 2023-12-08     |2023.2.3       |JH       |         |- scripts_vitis_unified, script_te_utils, bugfix DATA01_FILE for MB
# ------------------|---------------|---------|---------|----------------------------------------------------------------------
# -- 2023-12-06     |2023.2.2       |JH       |         |- modified script_petalinux, scripts_usrcommands, scripts_external
# ------------------|---------------|---------|---------|----------------------------------------------------------------------
# -- 2023-12-02     |2023.2.1       |JH       |         |- unified DATA01_FILE parameter for mcs,zynq,zynqmp and versal
# --                |               |         |         |- modify script_external, script_sdsoc(not longer used since 19.x) 
# --                |               |         |         |- add procedures list as todo and  finished history style update
# --                |               |         |         |- add script_vitis_unified(wip), current vitis script works with vitis classic only
# ------------------|---------------|---------|---------|----------------------------------------------------------------------
# -- 2023-11-22     |2023.2.0       |JH       |         |- 2023.2 initial release(22.2 copy)
# ------------------|---------------|---------|---------|----------------------------------------------------------------------
# -- 2023-09-25     |2022.2.9       |MK       |         |- correct shebang to #!/bin/bash for linux
# ------------------|---------------|---------|---------|----------------------------------------------------------------------
# -- 2023-09-04     |2022.2.8       |MK       |         |- modify script_external, script_petalinux
# ------------------|---------------|---------|---------|----------------------------------------------------------------------
# -- 2023-08-16     |2022.2.7       |MK       |         |- modify script_vivado(fix hw_get_fpga)
# ------------------|---------------|---------|---------|----------------------------------------------------------------------
# -- 2023-08-14     |2022.2.6       |JH       |         |- versal support and TE_GUI_DISABLED (petalinux), changes on: script_te_utils, script_vivado, script_vitis, script_petalinux
# ------------------|---------------|---------|---------|----------------------------------------------------------------------
# -- 2023-08-14     |2022.2.5       |JH       |         |- sync with 23.1 versal, script_te_utils, script_vivado, script_vitis
# ------------------|---------------|---------|---------|----------------------------------------------------------------------
# -- 2023-08-10     |2022.2.4       |JH       |         |- modify scripts_enviroment....
# --                |               |         |         |- modify proc print_environment_settings
# --                |               |         |         |- moved some environment parameter update so scripts_enviroment
# --                |               |         |         |- new script version
# ------------------|---------------|---------|---------|----------------------------------------------------------------------
# -- 2023-07-24     |2022.2.3       |JH       |x        |- script_petalinux, script_vitis
# --                |               |         |         |- new script version
# ------------------|---------------|---------|---------|----------------------------------------------------------------------
# -- 2023-06-16     |2022.2.2       |JH       |         |- script_te_utils changed
# ------------------|---------------|---------|---------|----------------------------------------------------------------------
# -- 2023-05-28     |               |JH       |         |- start versal support, init_app_list, sdef
# ------------------|---------------|---------|---------|----------------------------------------------------------------------
# -- 2023-05-25     |2022.2.1       |JH       |         |- start versal support, add VSYS,
# ------------------|---------------|---------|---------|----------------------------------------------------------------------
# -- 2023-02-08     |               |JH       |         |- unified sw app for data offset and load. Add missing MB Style update
# --                |               |         |         |- remove UBOOT_DTB_LOAD,UBOOT_DTB_OFFSET, BOOTSCR_LOAD and BOOTSCR_OFFSET 
# --                |               |         |         |- update change history on new style
# --                |               |         |         |- working in process
# ------------------|---------------|---------|---------|----------------------------------------------------------------------
# -- 2023-02-07     |2022.2.0       |JH       |         |- Start with 2022.2
# --                |               |         |         |
# ------------------|---------------|---------|---------|----------------------------------------------------------------------
# -- 2023/01/03     |2022.2.0       |MK       |         |- new version release 2022.2
# --                |               |         |         |- increase SW_IP_CSV version
# ------------------|---------------|---------|---------|----------------------------------------------------------------------
# -- 2022/10/26     |???            | JH      |         |- modify script_usrcommand,script_design, script_petalinux
# --                |               |         |         |- new script version
# ------------------|---------------|---------|---------|----------------------------------------------------------------------
# -- 2022/10/19     |???            | JH      |         |- modify script_te_utils,script_design
# --                |               |         |         |- new script version
# ------------------|---------------|---------|---------|----------------------------------------------------------------------
# -- 2022/10/14     |???            |JH       |         |- modify sscript_te_utils,script_environment
# --                |               |         |         |- new script version
# ------------------|---------------|---------|---------|----------------------------------------------------------------------
# -- 2022/09/24     |???            | JH      |         |- modify script_vivado , script_te_utils,script_environment
# --                |               |         |         |- new script version
# ------------------|---------------|---------|---------|----------------------------------------------------------------------
# -- 2022/09/21     |???            | JH      |         |- modify script_vivado and script_te_utils
# --                |               |         |         |- new script version
# ------------------|---------------|---------|---------|----------------------------------------------------------------------
# -- 2022/09/20     |???            |JH       |         |-  modify script_external and script_te_utils
# --                |               |         |         |-  TODO remove special UBOOT and dBOOTSCR entries on next releases...
# ------------------|---------------|---------|---------|----------------------------------------------------------------------
# -- 2022/09/17     |???            |JH       |         |- add  TE::SDEF::UBOOT_DTB_OFFSET TE::SDEF::BOOTSCR_OFFSET
...
# --                |               |         |         |- new script version
# ------------------|---------------|---------|---------|----------------------------------------------------------------------
# --2022/07/27      |???            |JH       |         |- script_usrcommandsl.tcl,
# --                |               |         |         |- new script version
# ------------------|---------------|---------|---------|----------------------------------------------------------------------
# --2022/10/26      |???            |JH       |         |- modify script_usrcommand,script_design, script_petalinux
# --                |               |         |         |- new script version
...
# --                |               |         |         |- new script version
# ------------------|---------------|---------|---------|----------------------------------------------------------------------
# --2022/05/06      |???            |JH       |         |- script_te_util.tcl,script_designs.tcl 
# --                |               |         |         |- new script version 
# ------------------|---------------|---------|---------|----------------------------------------------------------------------
# --2022/05/04      |???            |JH       |         |- script_te_util.tcl,script_designs.tcl,script_usrcommands.tcl 
# --                |               |         |         |- new script version 
# ------------------|---------------|---------|---------|----------------------------------------------------------------------
# --2022/04/26      |???            |JH       |         |- script_te_util.tcl,script_vivado 
# --                |               |         |         |- new script version 
# ------------------|---------------|---------|---------|----------------------------------------------------------------------
# --2022/03/17      |???            |JH       |         |- init_prod_tcl bugfix 
# ------------------|---------------|---------|---------|----------------------------------------------------------------------
# --2022/02/16      |???            |JH       |         |- add silent option to get_check_unique_name, find_id  and init_board 
# ------------------|---------------|---------|---------|----------------------------------------------------------------------
# --2022/01/27      |???            |JH       |         |-  script_te_util.tcl, script_designs.tcl, script_envirmonet.tcl 
...
# --                |               |         |         |- new script version- 
# ------------------|---------------|---------|---------|----------------------------------------------------------------------
# --2022/01/21      |???            |JH       |         |-  script_usrcommands.tcl 
# --                |               |         |         |- new script version 
# ------------------|---------------|---------|---------|----------------------------------------------------------------------
# --2022/01/20      |???            |JH       |         |-  script_te_util.tcl, script_petalinux.tcl, script_usrcommands.tcl, script_envirmonet.tcl 
# --                |               |         |         |- new script version 
# --                |               |         |         |- add new enviroment vaiables 
# ------------------|---------------|---------|---------|----------------------------------------------------------------------
# --2022/01/11      |???            |JH       |         |-  script_te_util.tcl, script_petalinux
# --                |               |         |         |- new script version
# ------------------|---------------|---------|---------|----------------------------------------------------------------------
# --2022/01/06      |???            |JH       |         |- script_te_util.tcl, script_usrcommands.tcl, script_external 
# --                |               |         |         |- new script version 
# ------------------|---------------|---------|---------|----------------------------------------------------------------------
# --2021/xx/xx      |???            |JH       |         |- renamed sdef platform into domain, new SW_IP_CSV version, add new parameter to csv list 
...
# --                |               |         |         |- new script version 
# ------------------|---------------|---------|---------|----------------------------------------------------------------------
# --2020/xx/xx      |???            |JH       |         |- new script version
...
# --                |               |         |         |- modified script_external.tcl
# ------------------|---------------|---------|---------|----------------------------------------------------------------------
# --2019/xx/xx      |???            |JH       |         |- new release version
# --                |               |         |         |- new script version
...
# ------------------|---------------|---------|---------|----------------------------------------------------------------------
# --2018/xx/xx      |???            |JH       |         |- new release version
...
# --                |               |         |         |- changed script_vivado.tcl
# ------------------|---------------|---------|---------|----------------------------------------------------------------------
# --2017/xx/xx      |???            |JH       |         |- new release version
...
# --                |               |         |         |- new release version
# --                |               |         |         |- new script version(6x) 
# ------------------|---------------|---------|---------|----------------------------------------------------------------------
# --2016/02/02      |???            |JH       |         |- initial release
# ------------------|---------------|---------|---------|----------------------------------------------------------------------
#
#List of procedures:
# --------------------------------------|---------|-----------------------------------------------------------------------
...
namespace eval ::TE {
  ...
  # -----------------------------------
  # Other envirment:
  # todo disable alle gui options automatically in case TE_GUI_DISABLED is set to 1
  variable TE_GUI_DISABLED 0    
  variable TE_WSL_USAGE 0
  variable TE_EDITOR 
  ...
  # -----------------------------------
  # check csv file ids
  variable SCRIPTVER    "2024.2.1"
  variable BOARDDEF_CSV "1.4"
  variable SW_IP_CSV    "2.6"
  ...
  # -----------------------------------------------------------------------------------------------------------------------------------------
    ...
    proc print_environment_settings {} {
      ...
      TE::UTILS::te_msg TE_INIT-1 INFO "Script Environment:\n \
        ...
        ------ \n \
        WSL USAGE:                $TE::TE_WSL_USAGE \n \
        TEXT Editor:              $TE::TE_EDITOR \n \
        ------ \n \
        SERIAL PATH:              $TE::SERIAL_PATH \n \
        COMPATH:                  $TE::COM_PATH \n \
        ------ \n \
        TE_GUI_DISABLED:          $TE::TE_GUI_DISABLED \n \
        ------ \n \
        PLX_SSTATE_CACHE_DOWNLOAD:$TE::PLX_SSTATE_CACHE_DOWNLOAD \n \
        PLX_SSTATE_CACHE_AARCH64: $TE::PLX_SSTATE_CACHE_AARCH64 \n \
        PLX_SSTATE_CACHE_MB_LITE: $TE::PLX_SSTATE_CACHE_MB_LITE \n \
        ------"
    ...
    proc check_bdtyp {} {
      ...
      foreach bd $bd_files {
        ...
        } elseif {[string match *vsys* $TE::BD_TCLNAME ]} {set TE::IS_VSYS true;    TE::UTILS::te_msg TE_INIT-?? STATUS "  TE::IS_VSYS:         $TE::IS_VSYS"
          ...
          if {[string match *#* $line] != 1 && [string match *CSV_VERSION* $line] } {
            ...
            if {$version_check eq false} {
              ...
              if {$table eq "domain"} {
                ...
                if {[string match "id" [lindex $tmp 0]] } {
                  ...
                  for {set i 0} {$i < $element_length} {incr i} {
                    ...
                    switch $element {
                      ...
                      "data01_file" {
                        set TE::SDEF::DATA01_FILE $i
                      }
                      "data01_load" {
                        set TE::SDEF::DATA01_LOAD $i
                      }
                      "data01_offset" {
                        set TE::SDEF::DATA01_OFFSET $i
                      }
                      default {
                ...
                #header
                if {[string match "id" [lindex $tmp 0]] } {
                  TE::UTILS::te_msg TE_INIT-197 INFO "Software Definition CSV Version analyse app table header"
                  set element NA
                  for {set i 0} {$i < $element_length} {incr i} {
                    set element [lindex $tmp $i]
                    switch $element {
              ...
              } elseif {$table eq "appVersal"} {
                #header
                if {[string match "id" [lindex $tmp 0]] } {
                  TE::UTILS::te_msg TE_INIT-199 INFO "Software Definition CSV Version analyse app table header"
                  set element NA
                  for {set i 0} {$i < $element_length} {incr i} {
                    set element [lindex $tmp $i]
                    ...
                    switch $element {
                      ...
                      "exception_level" {
                        set TE::SDEF::VERSAL_EXCEPTION_LEVEL $i
                      }
                      "atf" {
                        set TE::SDEF::VERSAL_ATF $i
                      }
                      "plm" {
                        set TE::SDEF::VERSAL_PLM $i
                      }
                      "psmfw" {
                        set TE::SDEF::VERSAL_PSMFW $i
                      }
                      "data01_file" {
                        set TE::SDEF::DATA01_FILE $i
                      }
                      ...
                      default {
                        if {[string match -nocase "data*" $element ]} {
                          ...
                          TE::UTILS::te_msg TE_INIT-??? {CRITICAL WARNING} "Software Definition CSV unknown element: $element for $table."
												}
                      }
                    }
                  }
                ...
                #header
                if {[string match "id" [lindex $tmp 0]] } {
                  TE::UTILS::te_msg TE_INIT-?? INFO "Software Definition CSV Version analyse app table header"
                  set element NA
                  for {set i 0} {$i < $element_length} {incr i} {
                    set element [lindex $tmp $i]
                    # puts "TestJH|$i|$element |$TE::SDEF::APPNAME"
  ...
  # -----------------------------------------------------------------------------------------------------------------------------------------
    ...
    set VERSAL_EXCEPTION_LEVEL        0
    set VERSAL_ATF                    0
    set VERSAL_PLM                    0
    set VERSAL_PSMFW                  0
    #... multiple files possible for data  02 (10...12), 03(13..15)
    set DATA01_FILE      0
    set DATA01_LOAD      0
    set DATA01_OFFSET    0
