...
# --                |               |         |         |
# ------------------|---------------|---------|---------|----------------------------------------------------------------------
# -- 2025-01-28     |               |JH       |         |- use_board add LAST_ID as default parameter
# ------------------|---------------|---------|---------|----------------------------------------------------------------------
# -- 2024-12-09     |               |JH       |         |- remove sdsoc tcl file
# ------------------|---------------|---------|---------|----------------------------------------------------------------------
# -- 2023-05-09     |               |JH       |         |- new change history
# --                |               |         |         |- add script_jtag.tcl
# ------------------|---------------|---------|---------|----------------------------------------------------------------------
# -- 2022/11/15     |               |JH       |         |- exit with negative code in case of failure
# ------------------|---------------|---------|---------|----------------------------------------------------------------------
# -- 2022/11/15     |               |MK       |         |- exit with negative code in case of failure
# ------------------|---------------|---------|---------|----------------------------------------------------------------------
# -- 2021/07/26     |               |JH       |         |- add petalinux tcl
# ------------------|---------------|---------|---------|----------------------------------------------------------------------
# -- 2020/03/02     |               |JH       |         |- check project path
# ------------------|---------------|---------|---------|----------------------------------------------------------------------
# -- 2020/02/25     |               |JH       |         |- remove program flash bin and flash mcs
# ------------------|---------------|---------|---------|----------------------------------------------------------------------
# -- 2019/01/28     |               |JH       |         |- new location for sdsoc_pfm.tcl
# ------------------|---------------|---------|---------|----------------------------------------------------------------------
# -- 2019/01/18     |               |JH       |         |- add run_board_selection as selection
# ------------------|---------------|---------|---------|----------------------------------------------------------------------
# -- 2017/09/04     |               |JH       |         |- add new document history style
# ------------------|---------------|---------|---------|----------------------------------------------------------------------
# -- 2017/06/30     |               |JH       |         |- miscellaneous
# ------------------|---------------|---------|---------|----------------------------------------------------------------------
