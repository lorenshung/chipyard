...
Basic documentations:
  ...
  ==
  Trenz Electronic product overview and articel name description
  https://wiki.trenz-electronic.de/display/PD/Current+Trenz+Electronic+Shop+Articles
  ...
  Edit "design_basic_settings.cmd" with text editor:
    Set your vivado installation path for edit: 
      ...
      In this example the it search in 
        C:\Xilinx\Vivado\2023.2 for VIVADO
        C:\Xilinx\Vitis\2023.2 for SDK (optional for some functionality, HSI/SDK)
        C:\Xilinx\Vivado_Lab\2023.2 for VIVADO Labtools (optional for programming only)
...
2.(optional) Create Vivado Project on Linux use instructions from option 1 of:
  ...
  Edit "design_basic_settings.sh" with text editor:
    Set your vivado installation path for edit: 
      ...
      @set VIVADO_VERSION=2023.2
      In this example the it search in 
        /opt/Vivado/2023.2 for VIVADO
        /opt/Vitis/2023.2 for SDK (optional for some functionality, HSI/SDK)
        /opt/Vivado_Lab/2023.2 for VIVADO Labtools (optional for programming only)
